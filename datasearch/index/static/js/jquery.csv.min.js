...
function() {
    "use strict";
    var r; (r = "undefined" != typeof jQuery && jQuery ? jQuery: {}).csv = {
        defaults: {
            separator: ",",
            delimiter: '"',
            headers: !0
        ...
        parsers: {
            parse: function(r, e) {
                ...
                l = !1;
                function c() {
                    if (n = 0, i = "", e.start && e.state.rowNum < e.start) return o = [],
                    e.state.rowNum++,
                    void(e.state.colNum = 1);
                    if (void 0 === e.onParseEntry) s.push(o);
                    else {
                        var r = e.onParseEntry(o, e.state); ! 1 !== r && s.push(r)
                    }
                    o = [],
                ...
                function u() {
                    if (void 0 === e.onParseValue) o.push(i);
                        ...
                        var r = e.onParseValue(i, e.state); ! 1 !== r && o.push(r)
                    }
                    i = "",
                    n = 0,
                    e.state.colNum++
                ...
                m = /(D|S|\r\n|\n|\r|[^DS\r\n]+)/,
                p = m.source;
                return p = (p = p.replace(/S/g, f)).replace(/D/g, d),
                m = new RegExp(p, "gm"),
                r.replace(m,
                function(r) {
                    if (!l) switch (n) {
            ...
            splitLines: function(e, a) {
                if (e) {
                    ...
                    f = /(D|S|\n|\r|[^DS\r\n]+)/,
                    d = f.source;
                    return d = (d = d.replace(/S/g, c)).replace(/D/g, u),
                    f = new RegExp(d, "gm"),
                    e.replace(f,
                    function(r) {
                        if (!l) switch (n) {
                ...
                function m() {
                    if (n = 0, a.start && a.state.rowNum < a.start) return i = "",
                    void a.state.rowNum++;
                    if (void 0 === a.onParseEntry) o.push(i);
                    else {
                        var r = a.onParseEntry(i, a.state); ! 1 !== r && o.push(r)
                    }
                    i = "",
            ...
            parseEntry: function(r, e) {
                ...
                function i() {
                    if (void 0 === e.onParseValue) s.push(n);
                        ...
                        var r = e.onParseValue(n, e.state); ! 1 !== r && s.push(r)
                    }
                    n = "",
                    o = 0,
                    e.state.colNum++
        ...
        toArray: function(e, a, t) {
            ...
            s.separator = "separator" in a ? a.separator: r.csv.defaults.separator,
            s.delimiter = "delimiter" in a ? a.delimiter: r.csv.defaults.delimiter;
        ...
        toObjects: function(e, a, t) {
            ...
            for (var u = 0,
            f = o.length; u < f; u++) {
                for (var d = r.csv.toArray(o[u], a), m = {},
                p = 0; p < c.length; p++) m[c[p]] = d[p];
                void 0 !== a.transform ? n.push(a.transform.call(void 0, m)) : n.push(m),
                a.state.rowNum++
            }
    ...
    "undefined" != typeof module && module.exports && (module.exports = r.csv)
}.call(this);